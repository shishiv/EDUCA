# Wireframe: Relatórios de Frequência (Desktop 1440×900)
...
- **[Gráfico Simples]**: Barra ou linha, frequência por turma ou unidade.
- **[Sticky Footer]**: Botão “Sair”, sempre visível na base da tela.
- **Responsividade**: Tabela e gráfico lado a lado ou empilhados, menu lateral fixo.
