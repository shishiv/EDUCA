# Wireframe: Formulário Wizard de Cadastro de Aluno/Responsável (Desktop 1440×900)
...
|------------------------------------------|--------------------------------------------|
| [Wizard: Etapas Laterais]                |                                            |
| 1. Dados do Aluno                        | [Indicador de Progresso: Etapa X de 5]     |
| 2. Responsável 1                         |                                            |
...
- **[Wizard: Etapas]**: Abas ou passos laterais, destaque para etapa atual.
...
- **Responsividade**: Etapas laterais, formulário centralizado, footer fixo.
