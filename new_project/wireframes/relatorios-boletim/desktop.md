# Wireframe: Relatórios de Boletim (Desktop 1440×900)
...
|--------------------------------------------|------------------------------------------|
| [Lista de Turmas]                          | [Botão: Visualizar/Exportar Boletim]     |
...
- **Responsividade**: Lista e tabela lado a lado ou empilhados, menu lateral fixo.
