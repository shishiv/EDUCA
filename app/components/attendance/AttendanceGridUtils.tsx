...
export function getSessionLockInfo(
  ...
  return getCanonicalSessionLockInfo(sessionDate, sessionStatus, currentTime, correctionDeadlineAt, scheduledCutoffAt)
}
...
export function useSessionLockInfo(
  ...
  return getSessionLockInfo(sessionDate, sessionStatus, correctionDeadlineAt, new Date(), scheduledCutoffAt)
}
