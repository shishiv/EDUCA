...
1.3. Update TypeScript types:
   ...
   pnpm supabase gen types typescript --project-id SUPABASE-PROJECT-REF > types/database.ts
   ```
...
4.2. Deploy Edge Function:
   ```bash
   # Deploy to Supabase
   supabase functions deploy auto-lock-sessions --project-ref SUPABASE-PROJECT-REF
