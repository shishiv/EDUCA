...
mcp__supabase__apply_migration({
  project_id: "wxvxlybwpvpenqveycon",
...
npx supabase gen types typescript --project-id "wxvxlybwpvpenqveycon" --schema public > types/database.ts
```
...
**How to avoid:** Verify project ID: `wxvxlybwpvpenqveycon`
...
- **Project ID:** `wxvxlybwpvpenqveycon`
- **Project Name:** EDUCA
- **Region:** sa-east-1
