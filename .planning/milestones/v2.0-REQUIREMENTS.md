# Requirements Archive: v2.0 Architecture & Launch Prep
...
- [x] **ADM-02**: Selecao persistente em sessionStorage/context global
- [x] **ADM-03**: Paginas escola-scoped usam selectedEscolaId quando disponivel
...
- [x] **ROL-01**: Restricao de registro de frequencia para perfil admin (view-only com mensagem explicativa)
- [x] **ROL-02**: Tela de gestao para atribuir professor/perfil a turmas (/dashboard/atribuicoes)
...
### Technical Debt Cleanup (INSERTED)

- [x] **CLN-01**: Completar TODOs em pages
- [x] **CLN-02**: Completar TODOs em components
- [x] **CLN-03**: Completar TODOs em lib/
- [x] **CLN-04**: Substituir mock data em Notas por Supabase real
- [x] **CLN-05**: Renomear 5 componentes kebab-case para PascalCase
- [x] **CLN-06**: Refatorar componentes grandes (AttendanceGrid, FrequenciaWorkflow >600 LOC)
- [x] **CLN-07**: Mover queries Supabase diretas para API services
- [ ] **CLN-08**: Integrar PostHog para analytics e error tracking - DEFERRED

### Dead Code Audit (INSERTED)

- [x] **DCA-01**: Audit unused exports via LSP findReferences
- [x] **DCA-02**: Remove confirmed dead code with git history preservation
- [x] **DCA-03**: Document audit methodology and findings

### Config Audit (INSERTED)

- [x] **CFG-01**: Auditar package.json (dependencies, scripts, versoes)
- [x] **CFG-02**: Auditar tsconfig.json e eslint.config.mjs
- [x] **CFG-03**: Auditar next.config.js e variaveis de ambiente
...
| CLN-01..07 | Phase 15 | Complete |
| CLN-08 | Phase 15 | Deferred |
| DCA-01..03 | Phase 15.1 | Complete |
| CFG-01..03 | Phase 15.2 | Complete |
...
**Adjusted:** ADM-*, CLN-*, DCA-*, CFG-* added during milestone execution
**Dropped:** None
**Deferred:** TST-03 (E2E), CLN-08 (PostHog)
